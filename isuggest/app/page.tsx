  ...
  return (
    ...
    <div className='flex mt-6'>
      ...
      <div className='flex items-center justify-center mr-[60px]'>
        {user  ?<Link href="/user"> <img className='w-[40px] hover:cursor-pointer border rounded-full border-[#4fb877] h-auto' src='/usericon.png' alt='user profile' /> </Link>: <Link href="/login"> <button className='w-[80px] items-center text-sm italic p-1 rounded-md hover:bg-gradient-to-r hover:from-[#ffa2f4] hover:to-[#b848ab] hover:text-white hover:border-none  border border-white'>Login</button></Link>}
      ...
      <div className='grid text-white grid-cols-2 items-center mt-5 w-full'>
        <div className='flex flex-col w-full items-center h-full'>
          ...
          <div className='flex w-full items-center text-sm ml-[200px] mt-4 flex-col'>
            <p className='flex w-full justify-start text-[13px]'>Discover the job your love, research on your favourite company</p>
