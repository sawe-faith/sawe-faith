    ...
    <div className='flex w-full  items-center flex-col  bg-gradient-to-r from-[#040313] to-[#0c093d]  text-white'>
      <div className='flex w-full mt-4 items-center justify-between '>
        ...
        <div className='mr-[30px]'>
         <Link href="/userprofile"> <img className={`w-[40px] hover:${<UserModal />}}   border rounded-full border-[#4fb877] h-auto `}  src='/usericon.png' alt='user profile' /></Link>
        </div>
      </div>
      <div className='grid w-full p-4 h-full grid-cols-6  gap-5 items-center justify-center'>
        <div className='flex gap-5  items-center w-full col-span-2 h-full   flex-col '>
          ...
          <div className='flex gap-9   items-center w-full col-span-4 h-[300px]  justify-center flex-col    shadow-lg bg-gradient-to-l from-[#040313] to-[#0c093d] rounded-lg ' >
        ...
        <div style={{ maxHeight: '600px', scrollbarWidth: 'none' }} className='flex overflow-y-auto items-center col-span-4 w-full flex-col h-full shadow-lg bg-gradient-to-l from-[#040313] to-[#0c093d] rounded-lg '>
          <div className='flex w-full items-center justify-start flex-col mt-12'>
            <h1 className='text-xl w-full justify-start ml-[60px] font-bold'>Jobs made availlable For you</h1>
            <p className='flex text-[10px] w-full ml-[60px] mt-3'>
              Click the learn more button to view more details for the job and apply!
            </p>
          </div>
