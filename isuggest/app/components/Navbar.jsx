...
const navbar = () => {
  return (
    <div className='flex items-center gap-10 text-sm border border-white rounded-xl justify-center p-2'>
      ...
      <Link className='flex items-center justify-center' href="/"><FaPeopleGroup className='mr-2'/>People</Link>
    </div>
  )
}
